...
urlpatterns = [
    ...
    path('comicbooks/<int:comic_id>/pages/<int:page_number>/panels/', views.PanelList.as_view(), name='panel-list'),
    path('comicbooks/<int:comic_id>/pages/<int:page_number>/panels/<int:panel_number>/', views.PanelDetail.as_view(), name='panel-detail'),
    ...
    path('comicbooks/<int:comic_id>/pages/<int:page_number>/panels/<int:panel_number>/speech_bubbles/<int:bubble_number>/', views.SpeechBubbleDetail.as_view(), name='speech-bubble-detail'),
